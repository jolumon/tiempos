...
################################################################################
## Form generated from reading UI file 'main3CziYkv.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2.setItem(6, QFormLayout.LabelRole, self.verticalSpacer)

        self.lbl_total_fab = QLabel(self.fabricacion)
        self.lbl_total_fab.setObjectName(u"lbl_total_fab")

        self.formLayout_2.setWidget(7, QFormLayout.LabelRole, self.lbl_total_fab)
        ...
        self.formLayout_2.setWidget(7, QFormLayout.FieldRole, self.le_total_fab)

        self.verticalSpacer_4 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.formLayout_2.setItem(8, QFormLayout.FieldRole, self.verticalSpacer_4)

        self.btn_calcular_fab = QPushButton(self.fabricacion)
        self.btn_calcular_fab.setObjectName(u"btn_calcular_fab")

        self.formLayout_2.setWidget(9, QFormLayout.FieldRole, self.btn_calcular_fab)
