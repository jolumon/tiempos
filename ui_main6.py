...
################################################################################
## Form generated from reading UI file 'main6OqfixY.ui'
##
...
"}")
        ...
        self.formLayout_3.setWidget(5, QFormLayout.LabelRole, self.cb_envasado_env)

        self.cmb_env = QComboBox(self.aprimario)
        self.cmb_env.setObjectName(u"cmb_env")
        self.cmb_env.setEnabled(False)

        self.formLayout_3.setWidget(5, QFormLayout.FieldRole, self.cmb_env)

        self.cb_limpieza_env = QCheckBox(self.aprimario)
        self.cb_limpieza_env.setObjectName(u"cb_limpieza_env")

        self.formLayout_3.setWidget(7, QFormLayout.LabelRole, self.cb_limpieza_env)
        ...
        self.formLayout_3.setWidget(8, QFormLayout.LabelRole, self.lbl_operarios_env)

        self.le_operarios_env = QLineEdit(self.aprimario)
        self.le_operarios_env.setObjectName(u"le_operarios_env")

        self.formLayout_3.setWidget(8, QFormLayout.FieldRole, self.le_operarios_env)

        self.verticalSpacer_2 = QSpacerItem(20, 60, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)

        self.formLayout_3.setItem(9, QFormLayout.LabelRole, self.verticalSpacer_2)
        ...
        self.formLayout_3.setWidget(10, QFormLayout.LabelRole, self.line_4)

        self.total_aprimario = QLabel(self.aprimario)
        self.total_aprimario.setObjectName(u"total_aprimario")

        self.formLayout_3.setWidget(11, QFormLayout.LabelRole, self.total_aprimario)
        ...
        self.formLayout_3.setWidget(11, QFormLayout.FieldRole, self.le_total_env)

        self.verticalSpacer_5 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.formLayout_3.setItem(12, QFormLayout.FieldRole, self.verticalSpacer_5)

        self.btn_calcular_env = QPushButton(self.aprimario)
        self.btn_calcular_env.setObjectName(u"btn_calcular_env")

        self.formLayout_3.setWidget(13, QFormLayout.FieldRole, self.btn_calcular_env)
        ...
        self.lbl_unidades.setIndent(0)

        self.formLayout_3.setWidget(2, QFormLayout.LabelRole, self.lbl_unidades)

        self.le_unidades = QLineEdit(self.aprimario)
        self.le_unidades.setObjectName(u"le_unidades")
        self.le_unidades.setReadOnly(True)

        self.formLayout_3.setWidget(2, QFormLayout.FieldRole, self.le_unidades)
