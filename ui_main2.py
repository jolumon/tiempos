...
################################################################################
## Form generated from reading UI file 'main2QIsvlr.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_operarios_fab = QLabel(self.fabricacion)
        self.lbl_operarios_fab.setObjectName(u"lbl_operarios_fab")

        self.formLayout_2.setWidget(6, QFormLayout.LabelRole, self.lbl_operarios_fab)

        self.le_operarios_fab = QLineEdit(self.fabricacion)
        self.le_operarios_fab.setObjectName(u"le_operarios_fab")

        self.formLayout_2.setWidget(6, QFormLayout.FieldRole, self.le_operarios_fab)
        ...
        self.line_2 = QFrame(self.aprimario)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setFrameShape(QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QFrame.Shadow.Sunken)

        self.formLayout_3.setWidget(6, QFormLayout.LabelRole, self.line_2)
        ...
        self.formLayout_4.setWidget(1, QFormLayout.LabelRole, self.cb_etiquetado_prod_sec)
        ...
        self.formLayout_4.setWidget(1, QFormLayout.FieldRole, self.cmb_etiquetado_prod_sec)

        self.cb_encajado_sec = QCheckBox(self.asecundario)
        self.cb_encajado_sec.setObjectName(u"cb_encajado_sec")

        self.formLayout_4.setWidget(2, QFormLayout.LabelRole, self.cb_encajado_sec)

        self.cb_etiq_idioma_sec = QCheckBox(self.asecundario)
        self.cb_etiq_idioma_sec.setObjectName(u"cb_etiq_idioma_sec")

        self.formLayout_4.setWidget(3, QFormLayout.LabelRole, self.cb_etiq_idioma_sec)

        self.cb_pack_sec = QCheckBox(self.asecundario)
        self.cb_pack_sec.setObjectName(u"cb_pack_sec")

        self.formLayout_4.setWidget(4, QFormLayout.LabelRole, self.cb_pack_sec)
        ...
        self.formLayout_4.setWidget(4, QFormLayout.FieldRole, self.cmb_pack_sec)

        self.cb_limpieza_sec = QCheckBox(self.asecundario)
        self.cb_limpieza_sec.setObjectName(u"cb_limpieza_sec")

        self.formLayout_4.setWidget(5, QFormLayout.LabelRole, self.cb_limpieza_sec)

        self.lbl_operarios_sec = QLabel(self.asecundario)
        self.lbl_operarios_sec.setObjectName(u"lbl_operarios_sec")

        self.formLayout_4.setWidget(6, QFormLayout.LabelRole, self.lbl_operarios_sec)

        self.le_operarios_sec = QLineEdit(self.asecundario)
        self.le_operarios_sec.setObjectName(u"le_operarios_sec")

        self.formLayout_4.setWidget(6, QFormLayout.FieldRole, self.le_operarios_sec)

        self.line_3 = QFrame(self.asecundario)
        self.line_3.setObjectName(u"line_3")
        self.line_3.setFrameShape(QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QFrame.Shadow.Sunken)

        self.formLayout_4.setWidget(7, QFormLayout.LabelRole, self.line_3)

        self.verticalSpacer_3 = QSpacerItem(20, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)

        self.formLayout_4.setItem(7, QFormLayout.FieldRole, self.verticalSpacer_3)

        self.lbl_total_sec = QLabel(self.asecundario)
        self.lbl_total_sec.setObjectName(u"lbl_total_sec")

        self.formLayout_4.setWidget(8, QFormLayout.LabelRole, self.lbl_total_sec)
        ...
        self.formLayout_4.setWidget(8, QFormLayout.FieldRole, self.le_total_sec)

        self.verticalSpacer_6 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.formLayout_4.setItem(9, QFormLayout.FieldRole, self.verticalSpacer_6)

        self.btn_calcular_sec = QPushButton(self.asecundario)
        self.btn_calcular_sec.setObjectName(u"btn_calcular_sec")

        self.formLayout_4.setWidget(10, QFormLayout.FieldRole, self.btn_calcular_sec)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_operarios_fab.setText(QCoreApplication.translate("MainWindow", u"Operarios", None))
        self.lbl_total_fab.setText(QCoreApplication.translate("MainWindow", u"Total", None))
        ...
        self.lbl_operarios_sec.setText(QCoreApplication.translate("MainWindow", u"Operarios", None))
